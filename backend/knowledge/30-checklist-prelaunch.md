# Lansman öncesi FirstClick kontrol listesi

- [ ] Tek cümlelik değer önerisi
- [ ] Hero CTA tek ve net
- [ ] Kart politikası yazılı
- [ ] Fiyat/limit görünür
- [ ] En az bir kanıt
- [ ] Empty state + ilk görev
- [ ] Jargon temizliği
- [ ] Mobil hero okunur
- [ ] Gizlilik/güvenlik linki
- [ ] Destek kanalı

Eksikler blindSpots ve actionPlan'a düşmeli; genel sohbet değil bu listeye referans ver [kb:prelaunch].

## Genişletilmiş uzman notları

e ekle. Skor etkisi: clarity ve adoption mobil kalitesine duyarlıdır; onboardingRisk form eksikliğinde yükselir.
...
FirstClick analisti Netlik alanında jargon, fayda dili ve mikro kopya sinyallerini birlikte okur. Ürün corpus'unda jargon vaadi varsa UI/fayda dili ile çelişki aranır; yoksa [kb] genel kuralı uygulanır. Persona tepkisinde mikro kopya sürtünmesi 

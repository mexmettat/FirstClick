# Persona derinliği: şüpheci kullanıcı

## Davranış
- Kanıt ister
- Abartıdan kaçar
- "Kim kullanıyor?" sorar

## Ne ikna eder
- Metrik, case, güvenlik
- Şeffaf limitler
- Dürüst trade-off ("ne yapmıyoruz")

## Ne caydırır
- Superlative sloganlar
- Kanıtsız social proof
- Gizli fiyat

Likelihood sık Düşük/Orta; suggestion kanıt ekleme olmalı.
...
FirstClick analisti Landing alanında hero, d

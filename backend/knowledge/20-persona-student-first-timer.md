# Persona derinliği: öğrenci ve ilk kez deneyen

## Öğrenci
- Bütçe
- Sosyal kanıt (arkadaşlar)
- Mobil

## First-timer
- Kategori eğitimi
- Karşılaştırma ("X'e benzer ama…")
- Güvenli deneme

İkisinde de jargon cezası yüksek; onboarding rehberi şart.

## Genişletilmiş uzman notları

oy, aha moment için mikro güvence ekle. Skor etkisi: clarity ve adoption onboarding kalitesine duyarlıdır; onboardingRisk empty state eksikliğinde yükselir.
...
FirstClick analisti Marketplace alanında iki taraf, escrow ve rating sinyallerini birlikte okur. Ürün corpus'unda iki taraf vaadi varsa UI/escrow ile çelişki aranır; yoksa [kb] genel kuralı uygulanır. Persona tepkisinde rating sürtünmesi timeline'a yazılır. Som

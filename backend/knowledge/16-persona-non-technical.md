# Persona derinliği: teknik bilmeyen kullanıcı

## Davranış
- Jargon korkusu
- Adım adım ister
- Hata mesajında panik

## Ne ikna eder
- Görsel rehber, video, basit dil
- İnsan destek sinyali

## Ne caydırır
- API-first anlatım
- Boş teknik dashboard
- Varsayılan İngilizce terimler

FirstClick bu personada confusion alanını kurulum ve dil üzerine kurmalı.

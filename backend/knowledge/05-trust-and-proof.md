# Güven sinyalleri ve kanıt

Skeptical persona FirstClick'te skor düşüren ana tiptir. Güven sinyali yoksa likelihood Düşük olur.

## Kanıt türleri
1. Müşteri logoları (tanınır marka)
2. Sayısal sonuç (metrik)
3. Üçüncü taraf inceleme (G2, Product Hunt)
4. Güvenlik (SOC2, KVKK, GDPR) — özellikle B2B
5. İnsan yüzü / kurucu hikayesi (erken aşama)

## Pazarlama dili tuzağı
- "Devrim niteliğinde", "dünyanın en iyisi" → skeptical tepkisi.
- Somut: "ortalama kurulum 4 dakika", "NPS 62".

## Güvenlik ve gizlilik
- Veri nerede? Kim erişir? Silme hakkı?
- B2B'de bu sorular toughQuestions'a girer.

## FirstClick kuralı
Corpus'ta kanıt yoksa persona "göremedim" desin; uydurma case study yazma. [kb:trust] ile genel kuralı, [doc:…] ile ürün kanıtını ayır.

## Genişletilmiş uzman notları

sti Fiyat alanında freemium, trial ve seat sinyallerini birlikte okur. Ürün corpus'unda freemium vaadi varsa UI/trial ile çelişki aranır; yoksa [kb] genel kuralı uygulanır. Persona tepkisinde seat sürtünmesi timeline'a yazılır. Somut öneri: freemium metnini tek cümleye indir, trial için görsel kanıt koy, seat için mikro güvence ekle. Skor etkisi: clarity ve adoption fiyat kalitesine duyarlıdır; onboardingRisk trial eksikliğinde yükselir.

# Citation disiplini (FirstClick RAG)

## Kaynak türleri
- [doc:…] kullanıcı dosyası
- [web:…] landing/URL
- [past:…] önceki analiz
- [kb:…] FirstClick bilgi tabanı (bu corpus)

## Kurallar
1. Ürün özelliği uydurma; doc/web yoksa "corpus'ta görmedim" de.
2. Genel UX kuralı için [kb:…] kullan.
3. Geçmiş test tekrarı için [past:…].
4. citations dizisini doldur.

Persona metninde hem kb hem doc birlikte kullanılabilir: "Dokümanda tek tık vaadi var [doc:…] ama kurulum best-practice'ine göre 3 adımdan fazla olmamalı [kb:onboarding]."

## Genişletilmiş uzman notları

boardingRisk trial eksikliğinde yükselir.
